...
func init() {
	...
	passfilecmdapi.Flags().StringP("filename", "f", "", "enter the json file data.")
	//configCmd.Flags().StringVarP(&filename, "filename", "c", "", "config file (default is $HOME/.config.yaml)")
